...
//	
//	private String CLIENT_ID = "763971359461-9lfqph5au0nq8m152udh8sh30jnuq4ae.apps.googleusercontent.com"; // 애플리케이션 클라이언트 아이디값";
//	private String CLI_SECRET = "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"; // 애플리케이션 클라이언트 시크릿값";
//									
//	/**
//	 * 콜백 페이지 컨트롤러
//	 * 
...
//	public String TestGoogleCallback(HttpSession session
...
//		String redirectURI = URLEncoder.encode("http://localhost:8080/driver/login/google/redirect", "UTF-8");
//
//		System.out.println("code= " + code);
//		
//		String apiURL = "https://accounts.google.com/o/oauth2/v2/auth?"
//				+ "scope=https://www.googleapis.com/auth/cloud-identity.devices."
//				+ "lookup&access_type=offline&include_granted_scopes=true&state"
//				+ "=state_parameter_passthrough_value&"
//				+ "redirect_uri=http://localhost:8080/driver/login/google/redirect&"
//				+ "response_type=code&client_id=763971359461-9lfqph5au0nq8m152udh8sh30jnuq4ae.apps"
