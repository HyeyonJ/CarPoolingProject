...
public class PsReviewController {
	...
	@ResponseBody
	@PutMapping("/passengerCarpool/review/edit")
	public void editReview(@RequestParam Integer rIdx, @RequestParam String content) {
		passengerReviewRepository.updateReview(rIdx, content);
	}
	
	@ResponseBody
	@DeleteMapping("/passengerCarpool/review/delete")
	public void deleteReview(@RequestParam Integer rIdx) {
		passengerReviewRepository.deleteReview(rIdx);
	}
}	
